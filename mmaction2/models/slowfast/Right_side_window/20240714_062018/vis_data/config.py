ann_file_test = 'data/video/Right_side_window_val.txt'
ann_file_train = 'data/video/Right_side_window_train.txt'
ann_file_val = 'data/video/Right_side_window_val.txt'
data_root = 'data'
data_root_val = 'data'
...
test_dataloader = dict(
    batch_size=1,
    dataset=dict(
        ann_file='data/video/Right_side_window_val.txt',
...
train_dataloader = dict(
    batch_size=12,
    dataset=dict(
        ann_file='data/video/Right_side_window_train.txt',
        data_prefix=dict(video='data'),
        pipeline=[
            dict(io_backend='disk', type='DecordInit'),
            dict(
...
work_dir = 'models/slowfast/Right_side_window'
